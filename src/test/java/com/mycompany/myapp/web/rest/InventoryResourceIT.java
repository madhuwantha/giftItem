...
public class InventoryResourceIT {
    ...
    public void createInventory() throws Exception {
        ...
        assertThat(testInventory.getAvalibleQuantity()).isEqualTo(DEFAULT_AVALIBLE_QUANTITY);
    }
    ...
    public void updateInventory() throws Exception {
        ...
        Inventory testInventory = inventoryList.get(inventoryList.size() - 1);
        assertThat(testInventory.getAvalibleQuantity()).isEqualTo(UPDATED_AVALIBLE_QUANTITY);
    }
